...
#include "../../ObjectOriented_Quality/test_ui.h"
...
const QMetaObject Test_ui::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_Test_ui.data,
      qt_meta_data_Test_ui,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *Test_ui::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_Test_ui.stringdata))
        return static_cast<void*>(const_cast< Test_ui*>(this));
